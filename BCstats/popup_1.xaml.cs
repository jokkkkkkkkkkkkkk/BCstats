...
namespace BCstats {
    ...
    /// popup_1.xaml 的交互逻辑
    /// </summary>
    public partial class popup_1 : Window {

        public popup_1(Window owner) {
        ...
        /// <param name="e"></param>
        private void popupWindow1_Loaded(object sender, RoutedEventArgs e) {
            try {

                // 获取根目录测试``


                //MessageBox.Show("根目录：" + root);
                ...
                // popup1_dataGrid1.Items.Clear();
                // 将表对象作为DataGridView的数据源
                //popup1_dataGrid1.ItemsSource = dt.AsDataView();   // 无显示
                popup1_dataGrid1.ItemsSource = dt.DefaultView;
                // 禁止用户排序
                popup1_dataGrid1.CanUserSortColumns = false;
                // 在后台阻止最后一行的空行
                popup1_dataGrid1.CanUserAddRows = false;
        ...
        private void btnAdd_Click(object sender, RoutedEventArgs e) {
            ...
            // 允许创建新的行
            popup1_dataGrid1.CanUserAddRows = true;
        }
        ...
        private void btnSave_Click(object sender, RoutedEventArgs e) {
            try {
                ...
                dt = ((DataView)popup1_dataGrid1.ItemsSource).ToTable();
                // 获取DataTable所有的列名称
        ...
        private void btnDelete_Click(object sender, RoutedEventArgs e) {
            // 目前选中的一行
            if (popup1_dataGrid1.SelectedIndex >= 0) {
                // 获取DataGrid的某一行的某一个单元格的内容
                DataRowView dataRowView = (DataRowView)popup1_dataGrid1.SelectedItem;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void popup1_dataGrid1_BeginningEdit(object sender, DataGridBeginningEditEventArgs e) 
        {           
            //try
            //{
            ...
            //    //假设这里就是操作文本列
           /* if (popup1_dataGrid1.CurrentColumn.Header.ToString() != "周二检修否")    //选中其他
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void popup1_dataGrid1_CellEditEnding(object sender, DataGridCellEditEndingEventArgs e) {
            try {
                DataTable dt = new DataTable();
                // 用DataTable读取datagrid内容
                dt = ((DataView)popup1_dataGrid1.ItemsSource).ToTable();

                int id = popup1_dataGrid1.SelectedIndex;
